const GravitationExplore = () => (
  <div className="space-y-6">
    <div>
      <h2 className="text-2xl font-light text-white mb-2">Gravitation</h2>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      <div className="bg-secondary/40 p-4 rounded-lg">
        ...
        <h4 className="text-sm font-display tracking-wide text-white">Kepler's Laws</h4>
      ...
      <div className="bg-secondary/40 p-4 rounded-lg">
        <div className="text-lg mb-1">🚀</div>
        <h4 className="text-sm font-display tracking-wide text-white">Orbital Energy</h4>
        <p className="text-xs text-slate-400">
