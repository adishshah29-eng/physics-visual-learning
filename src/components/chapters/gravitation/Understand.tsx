const GravitationUnderstand = () => (
  <div className="space-y-6">
    ...
    <div className="glass-panel p-4 rounded-lg space-y-2">
      <h3 className="text-sm font-display tracking-wide text-white">Newton's Law of Gravitation</h3>
      <div className="font-mono text-sm text-primary bg-black/20 p-2 rounded">F = GMm / r²</div>
      <p className="text-xs text-slate-400">G = 6.674 × 10⁻¹¹ N·m²/kg² (universal gravitational constant)</p>
    </div>

    <div className="glass-panel p-4 rounded-lg space-y-2">
      <h3 className="text-sm font-display tracking-wide text-white">Gravitational Field & Surface Gravity</h3>
    ...
    <div className="glass-panel p-4 rounded-lg space-y-2">
      <h3 className="text-sm font-display tracking-wide text-white">Gravitational Potential & PE</h3>
      <div className="space-y-1">
      ...
      <p className="text-xs text-slate-400">Zero reference is at r = ∞. PE is always negative in a bound system.</p>
    </div>

    <div className="glass-panel p-4 rounded-lg space-y-2">
      <h3 className="text-sm font-display tracking-wide text-white">Orbital Motion (Circular Orbit)</h3>
      <div className="space-y-1">
      ...
      <p className="text-xs text-slate-400">Note: KE = ½|PE| = |E_total| for any circular orbit (Virial theorem)</p>
    </div>

    <div className="glass-panel p-4 rounded-lg space-y-2">
      <h3 className="text-sm font-display tracking-wide text-white">Escape Velocity</h3>
      <div className="font-mono text-sm text-primary bg-black/20 p-2 rounded">v_esc = √(2GM/R) = √(2gR) ≈ 11.2 km/s (Earth)</div>
      <p className="text-xs text-slate-400">v_esc = √2 × v_orbital (near surface). Independent of mass and direction!</p>
    </div>

    <div className="glass-panel p-4 rounded-lg space-y-2">
      <h3 className="text-sm font-display tracking-wide text-white">Kepler's Laws</h3>
      <div className="space-y-1">
    ...
    <div className="glass-panel p-4 rounded-lg space-y-1">
      <h3 className="text-sm font-display tracking-wide text-white">Satellite Periods</h3>
