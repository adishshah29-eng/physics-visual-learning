const ThermodynamicsUnderstand = () => (
  <div className="space-y-6">
    ...
    <div className="glass-panel p-4 rounded-lg space-y-2">
      <h3 className="text-sm font-display tracking-wide text-white">First Law of Thermodynamics</h3>
      <div className="font-mono text-sm text-primary bg-black/20 p-2 rounded">Q = ΔU + W</div>
      <p className="text-xs text-slate-400">Q = heat added, ΔU = change in internal energy, W = work done BY gas.</p>
    </div>

    <div className="glass-panel p-4 rounded-lg space-y-2">
      <h3 className="text-sm font-display tracking-wide text-white">Ideal Gas & Internal Energy</h3>
      ...
      <p className="text-xs text-slate-400">f = degrees of freedom: mono=3, di=5, poly=6</p>
    </div>

    <div className="glass-panel p-4 rounded-lg space-y-2">
      <h3 className="text-sm font-display tracking-wide text-white">Isothermal Process (T = const)</h3>
      <div className="space-y-1">
    ...
    <div className="glass-panel p-4 rounded-lg space-y-2">
      <h3 className="text-sm font-display tracking-wide text-white">Adiabatic Process (Q = 0)</h3>
      <div className="space-y-1">
    ...
    <div className="glass-panel p-4 rounded-lg space-y-2">
      <h3 className="text-sm font-display tracking-wide text-white">Isobaric (P = const) & Isochoric (V = const)</h3>
      <div className="space-y-1">
    ...
    <div className="glass-panel p-4 rounded-lg space-y-2">
      <h3 className="text-sm font-display tracking-wide text-white">Heat Engines & Carnot Cycle</h3>
      <div className="space-y-1">
