const WavesUnderstand = () => (
  <div className="space-y-6">
    ...
    <div className="bg-secondary/30 p-4 rounded-lg space-y-2">
      <h3 className="text-sm font-semibold text-foreground">General Wave Equation</h3>
    ...
    <div className="bg-secondary/30 p-4 rounded-lg space-y-2">
      <h3 className="text-sm font-semibold text-foreground">Wave Speed in Different Media</h3>
      <div className="space-y-1">
    ...
    <div className="bg-secondary/30 p-4 rounded-lg space-y-2">
      <h3 className="text-sm font-semibold text-foreground">Superposition Principle</h3>
      <div className="font-mono text-sm text-primary bg-black/20 p-2 rounded">y = y₁ + y₂ &nbsp; (algebraic addition)</div>
      <p className="text-xs text-muted-foreground">Constructive: Δφ = 0, 2π, 4π… &nbsp; Destructive: Δφ = π, 3π, 5π…</p>
    </div>

    <div className="bg-secondary/30 p-4 rounded-lg space-y-2">
      <h3 className="text-sm font-semibold text-foreground">Standing Waves</h3>
      <div className="space-y-1">
    ...
    <div className="bg-secondary/30 p-4 rounded-lg space-y-2">
      <h3 className="text-sm font-semibold text-foreground">Harmonics (String fixed at both ends)</h3>
      <div className="space-y-1">
    ...
    <div className="bg-secondary/30 p-4 rounded-lg space-y-2">
      ...
      <p className="text-xs text-muted-foreground">Number of beats per second = |f₁ − f₂|. Used for tuning instruments.</p>
    </div>

    <div className="bg-secondary/30 p-4 rounded-lg space-y-2">
      <h3 className="text-sm font-semibold text-foreground">Intensity & Energy</h3>
      <div className="space-y-1">
