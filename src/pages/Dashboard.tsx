...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-transparent text-slate-100 pb-20 overflow-x-hidden selection:bg-sky-500/30">
      <Navbar />
              ...
              className={`
                ...
                ${
                  selectedCategory === cat.id
                    ...
                    : "glass-panel text-slate-400 hover:border-sky-500/30 transition-colors hover:text-white"
                }
              `}
            >
              {cat.label}
          ...
          {class11.length > 0 && (
            <section>
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-display tracking-wide text-white">Class 11</h2>
          ...
          {class12.length > 0 && (
            <section>
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-display tracking-wide text-white">Class 12</h2>
